...
class FieldsideV2SupabaseUser extends BaseAuthUser {
  FieldsideV2SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> fieldsideV2SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = FieldsideV2SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
