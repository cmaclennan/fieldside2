...
class SideBarNavWidget extends StatefulWidget {
  ...
  final Color? sheratonBG;
  final Widget? sheratonIcon;
  final Color? pullmanColor;
  final Widget? pullmanIcon;
  final Widget? roamIcon;
  final Widget? reportIcon;
  final Color? roamBG;
  final Color? reportBG;
  final Widget? profileIcon;
  final Color? profileBG;
  final Widget? inventoryIcon;
  final Color? inventoryColor;
  final Widget? jobicon;
                ...
                children: [
                  if (Theme.of(context).brightness == Brightness.light)
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/fieldsidev2_logo_trn.png',
                        width: 130.0,
                        height: 40.0,
                        fit: BoxFit.fitWidth,
                      ),
