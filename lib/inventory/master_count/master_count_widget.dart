...
import 'master_count_model.dart';
export 'master_count_model.dart';

class MasterCountWidget extends StatefulWidget {
  const MasterCountWidget({super.key});

  static String routeName = 'master_count';
  static String routePath = 'masterCount';

  @override
  State<MasterCountWidget> createState() => _MasterCountWidgetState();
}

class _MasterCountWidgetState extends State<MasterCountWidget> {
  late MasterCountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MasterCountModel());
                          ...
                          child: FutureBuilder<List<ShedInventoryRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ShedInventoryRow>
                                  columnShedInventoryRowList = snapshot.data!;

                              final columnShedInventoryRow =
                                  columnShedInventoryRowList.isNotEmpty
                                      ? columnShedInventoryRowList.first
                                      : null;
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 16.0, 0.0, 10.0),
                                      child: Text(
                                        'Master Stock Count - Update Values',
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                            ...
                                            text: columnShedInventoryRow?.salt
                                                ?.toString(),
                                          ),
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.bufferTextController ??=
                                                  TextEditingController(
                                            text: columnShedInventoryRow?.buffer
                                                ?.toString(),
                                          ),
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.acidTextController ??=
                                                  TextEditingController(
                                            text: columnShedInventoryRow?.acid
                                                ?.toString(),
                                          ),
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.sdicTextController ??=
                                                  TextEditingController(
                                            text: columnShedInventoryRow?.sdic
                                                ?.toString(),
                                          ),
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  await ShedInventoryTable()
                                                      .update(
                                                    data: {
                                                      'salt': int.tryParse(_model
                                                          .saltTextController
                                                          .text),
                                                      'buffer': int.tryParse(_model
                                                          .bufferTextController
                                                          .text),
                                                      'calcium': int.tryParse(_model
                                                          .calciumTextController
                                                          .text),
                                                      'cyanuric': int.tryParse(
                                                          _model
                                                              .cyanuricTextController
                                                              .text),
                                                      'acid': int.tryParse(_model
                                                          .acidTextController
                                                          .text),
                                                      'sdic': int.tryParse(_model
                                                          .sdicTextController
                                                          .text),
                                                    },
                                                    matchingRows: (rows) =>
