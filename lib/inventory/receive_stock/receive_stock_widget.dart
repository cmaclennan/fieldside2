...
import 'receive_stock_model.dart';
export 'receive_stock_model.dart';

class ReceiveStockWidget extends StatefulWidget {
  const ReceiveStockWidget({super.key});

  static String routeName = 'receive_stock';
  static String routePath = 'receiveStock';

  @override
  State<ReceiveStockWidget> createState() => _ReceiveStockWidgetState();
}

class _ReceiveStockWidgetState extends State<ReceiveStockWidget> {
  late ReceiveStockModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReceiveStockModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 16.0, 0.0, 0.0),
                                  child: Text(
                                    'Stock to be added to inventory',
