  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case ResortPoolTestingRow:
            return ResortPoolTestingRow(data);
          case SheratonPoolTestingRow:
            return SheratonPoolTestingRow(data);
          case ShedInventoryRow:
            return ShedInventoryRow(data);
          case JobSheetsRow:
            return JobSheetsRow(data);
          case LogbookRow:
            return LogbookRow(data);
          case SeaTempleStartDayRow:
            return SeaTempleStartDayRow(data);
          case SheratonFreshwaterPlantRow:
            return SheratonFreshwaterPlantRow(data);
          case SheratonBackwashRow:
            return SheratonBackwashRow(data);
          case SeaTempleUnitBookingsRow:
            return SeaTempleUnitBookingsRow(data);
          case SeaTempleUnitTestsRow:
            return SeaTempleUnitTestsRow(data);
          case WholesaleRow:
            return WholesaleRow(data);
          case SeaTempleBackwashRow:
            return SeaTempleBackwashRow(data);
          case UsersRow:
            return UsersRow(data);
          case SeaTempleUnitChemicalsRow:
            return SeaTempleUnitChemicalsRow(data);
          case ResortPoolChemicalsRow:
            return ResortPoolChemicalsRow(data);
          case SheratonSaltwaterPlantRow:
            return SheratonSaltwaterPlantRow(data);
          case SeaTempleUnitsRow:
            return SeaTempleUnitsRow(data);
          default:
            return null;
        }
