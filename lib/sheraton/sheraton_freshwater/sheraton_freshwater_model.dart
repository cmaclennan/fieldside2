...
import 'sheraton_freshwater_widget.dart' show SheratonFreshwaterWidget;
import 'package:flutter/material.dart';

class SheratonFreshwaterModel
    extends FlutterFlowModel<SheratonFreshwaterWidget> {
  ...
  // State field(s) for Valve1 widget.
  FocusNode? valve1FocusNode;
  TextEditingController? valve1TextController;
  String? Function(BuildContext, String?)? valve1TextControllerValidator;
  ...
  void dispose() {
    ...
    valve1FocusNode?.dispose();
    valve1TextController?.dispose();
