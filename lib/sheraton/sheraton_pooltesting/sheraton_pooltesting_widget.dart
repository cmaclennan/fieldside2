...
import 'sheraton_pooltesting_model.dart';
export 'sheraton_pooltesting_model.dart';

class SheratonPooltestingWidget extends StatefulWidget {
  const SheratonPooltestingWidget({
    super.key,
  ...
  static String routeName = 'sheraton_pooltesting';
  static String routePath = 'sheratonPooltesting';

  @override
  State<SheratonPooltestingWidget> createState() =>
      _SheratonPooltestingWidgetState();
}

class _SheratonPooltestingWidgetState extends State<SheratonPooltestingWidget> {
  late SheratonPooltestingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SheratonPooltestingModel());
                                  ...
                                  children: [
                                    Flexible(
                                      child: Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .selectTimeValueController ??=
                                              FormFieldController<String>(null),
                                          options: ['Morning', 'Afternoon'],
                                          onChanged: (val) => safeSetState(() =>
                                              _model.selectTimeValue = val),
                                          width: 200.0,
                                          height: 40.0,
                                          textStyle: FlutterFlowTheme.of(
                                                  context)
                                      ...
                                      Flexible(
                                        child: Align(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await SheratonPoolTestingTable()
                                                  .insert({
                                                ...
                                                'pool': _model.selectPoolValue,
                                                'test_time':
                                                    _model.selectTimeValue,
                                              });

                                              context.pushNamed(
                                                  SheratonWidget.routeName);
                                            },
                                            text: 'Submit',
