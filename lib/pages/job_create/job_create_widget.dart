...
class JobCreateWidget extends StatefulWidget {
  const JobCreateWidget({super.key});

  static String routeName = 'job_create';
  static String routePath = 'jobCreate';
...
class _JobCreateWidgetState extends State<JobCreateWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobCreateModel());

    _model.nameTextController ??= TextEditingController();
    _model.nameFocusNode ??= FocusNode();

    _model.seaTemplePrivateTextController ??= TextEditingController();
    _model.seaTemplePrivateFocusNode ??= FocusNode();

    _model.otherLocTextController ??= TextEditingController();
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        10.0, 5.0, 0.0, 0.0),
                                                child: Text(
                                                  'Create Job Sheet Entry for:     ${dateTimeFormat("d/M/y", getCurrentTimestamp)}',
                                                  style:
                                                      FlutterFlowTheme.of(
                                                              context)
                                                          .titleSmall
