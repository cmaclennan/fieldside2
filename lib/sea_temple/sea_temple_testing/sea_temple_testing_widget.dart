...
import '/components/add_chemical_selection_s_t/add_chemical_selection_s_t_widget.dart';
...
import 'sea_temple_testing_model.dart';
export 'sea_temple_testing_model.dart';

class SeaTempleTestingWidget extends StatefulWidget {
  const SeaTempleTestingWidget({
    super.key,
    required this.unit,
    required this.owner,
    required this.test,
  ...
  static String routeName = 'sea_temple_testing';
  static String routePath = 'seaTempleTesting';

  @override
  State<SeaTempleTestingWidget> createState() => _SeaTempleTestingWidgetState();
}

class _SeaTempleTestingWidgetState extends State<SeaTempleTestingWidget> {
  late SeaTempleTestingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeaTempleTestingModel());
