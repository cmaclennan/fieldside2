...
import 'sea_temple_chemicals_model.dart';
export 'sea_temple_chemicals_model.dart';

class SeaTempleChemicalsWidget extends StatefulWidget {
  const SeaTempleChemicalsWidget({
    super.key,
    required this.unit,
    int? salt,
    int? alk,
  ...
  static String routeName = 'sea_temple_chemicals';
  static String routePath = 'seaTempleChemicals';

  @override
  State<SeaTempleChemicalsWidget> createState() =>
      _SeaTempleChemicalsWidgetState();
}

class _SeaTempleChemicalsWidgetState extends State<SeaTempleChemicalsWidget> {
  late SeaTempleChemicalsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeaTempleChemicalsModel());
                                      ...
                                      Flexible(
                                        child: Align(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await SeaTempleUnitChemicalsTable()
                                                  .insert({
