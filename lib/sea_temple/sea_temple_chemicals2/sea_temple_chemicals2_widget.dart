...
import 'sea_temple_chemicals2_model.dart';
export 'sea_temple_chemicals2_model.dart';

class SeaTempleChemicals2Widget extends StatefulWidget {
  const SeaTempleChemicals2Widget({
    super.key,
    required this.unit,
    int? salt,
    int? alk,
  ...
  static String routeName = 'sea_temple_chemicals2';
  static String routePath = 'seaTempleChemicals2';

  @override
  State<SeaTempleChemicals2Widget> createState() =>
      _SeaTempleChemicals2WidgetState();
}

class _SeaTempleChemicals2WidgetState extends State<SeaTempleChemicals2Widget> {
  late SeaTempleChemicals2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeaTempleChemicals2Model());
